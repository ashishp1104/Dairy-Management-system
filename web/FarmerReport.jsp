...
<%@include file="dropdown.jsp" %>
        ...
        <span class="bg-light"><%=date %></span><p class="text-center">Farmer Report</p>
...
<div class="container text-center">
  <button type="submit" class="btn btn-warning" name="DeliveryReport" id="farmerReport" onclick="delivery()">Print</button>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
	...
	function delivery(){
		...
		document.getElementById("farmerReport").style.visibility = "hidden";  
