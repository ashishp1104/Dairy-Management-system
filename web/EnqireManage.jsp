...
<%@include file="dropdown.jsp" %>
        ...
        <span class="bg-light"><%=date %></span><p class="text-center">Enqire</p>
  ...
  try{
	  ...
	  String query="select * from enqire";
  ...
  <tbody>
    <tr>
      ...
      <td><%=rs.getString("feedback_massage") %></td>
...
<div class="container text-center">
  <button type="submit" class="btn btn-warning" name="DeliveryReport" id="enqireReport" onclick="enqire()">Print</button>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
	...
	function enqire(){
		...
		document.getElementById("enqireReport").style.visibility = "hidden";  
		document.getElementById("nav").style.visibility = "hidden";  
		document.getElementById("side").style.visibility = "hidden";  
		window.print();
		window.location.href = "EnqireManage.jsp";
