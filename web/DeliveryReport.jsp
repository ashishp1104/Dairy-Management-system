...
<!-- Header -->
<nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark" id="nav">
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark" data-bs-theme="dark" id="side">
                   ...
                   <!--   <li class="nav-item">
                    ...
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="MilkCollection.jsp" class="nav-link px-0 text-white"> <span><i class="fa-solid fa-plus" style="color: #B197FC;"></i> </span><span class="d-none d-sm-inline">Add</span> </a>
                            </li>
                            <li>
                                <a href="Managemilk.jsp" class="nav-link px-0 text-info"><span><i class="fa-solid fa-pen-to-square" style="color: #B197FC;"></i></span> <span class="d-none d-sm-inline"> Manage</span> </a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<%@include file="dropdown.jsp" %>
        ...
        <span class="bg-light"><%=date %></span><p class="text-center">Delivery Report</p>
...
<div class="container text-center">
  <button type="submit" class="btn btn-warning" name="DeliveryReport" id="DeliveryReport" onclick="delivery()">Print</button>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
	...
	function delivery(){
		...
		document.getElementById("DeliveryReport").style.visibility = "hidden";  
		document.getElementById("nav").style.visibility = "hidden";  
		document.getElementById("side").style.visibility = "hidden";  
		window.print();
		window.location.href = "DeliveryReport.jsp";
